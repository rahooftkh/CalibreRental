 ...
 */
     ...
     */
            subscribe: function subscribe(propertyAlias, culture, fieldName, callback, segment) {
                if (!callback) {
                    return;
                }
     ...
     */
            getPropertyCallbacks: function getPropertyCallbacks(propertyAlias, culture, fieldName, segment) {
                //normalize culture to "invariant"
                if (!culture) {
                    culture = 'invariant';
                }
     ...
     */
            getVariantCallbacks: function getVariantCallbacks(culture, segment) {
                var found = _.filter(callbacks, function (item) {
     ...
     */
            removePropertyError: function removePropertyError(propertyAlias, culture, fieldName, segment) {
                if (!propertyAlias) {
                    return;
                }
                //normalize culture to null
     ...
     */
            hasPropertyError: function hasPropertyError(propertyAlias, culture, fieldName, segment) {
                //normalize culture to null
                if (!culture) {
                    culture = 'invariant';
                }
